...
public class ConexaoDB extends SQLiteOpenHelper {
    ...
    private final String CREATE_TABLE_RENDIMENTO = "CREATE TABLE IF NOT EXISTS rendimento " +
            "(id INTEGER PRIMARY KEY AUTOINCREMENT, descricao TEXT NOT NULL, valor REAL NOT NULL, data TEXT NOT NULL, id_categoria INTEGER NOT NULL, FOREIGN KEY (id_categoria) REFERENCES categoria (id));";
